...
public class ShoppingWindow
{
	...
	private class buildchaepChairPanel extends JPanel
	{
		...
		{		
			...
			ImageIcon icon = new ImageIcon("src\\Store\\CheapChair.jpg");
	...
	private class buildBedFramePanel extends JPanel
	{
		...
		buildBedFramePanel()
		{
			...
			ImageIcon icon = new ImageIcon("src\\Store\\bedframe.jpg");
	...
	private class buildDresserpanel extends JPanel
	{
		...
		buildDresserpanel()
		{
			...
			ImageIcon icon = new ImageIcon("src\\Store\\dresser.jpg");
			imglabel = new JLabel(icon);
	...
	private class buildtablepanel extends JPanel
	{
		...
		buildtablepanel()
		{
			...
			ImageIcon icon = new ImageIcon("src\\Store\\table.jpg");
			imglabel = new JLabel(icon);
	...
	private class buildofficechairpanel extends JPanel
	{
		...
		{		
			...
			ImageIcon icon = new ImageIcon("src\\Store\\officechair.jpg");
			imglabel = new JLabel(icon);
